...
import com.ultrapower.Service.IpUtil;
...
public class DetectController {
	Logger logger = LoggerFactory.getLogger(DetectController.class);
...
//	@ResponseStatus(HttpStatus.OK)
	public String getUserJudgeAnalysisByQuery(@RequestParam("url") String curl, HttpServletRequest request) {
		String result = "";
...
//		log.info(msg);
		...
		logger.info("client IP : " + IpUtil.getIpAddr(request));
		logger.info(result);
		return result;
	}
}